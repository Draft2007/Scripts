@ECHO OFF
REM *************************************************************************
REM Author: Jason Fossen, Ver: 2.0, Date: 15.Mar.05 
REM
...
REM
REM If TLNTADMN.EXE is not already installed locally, you will
REM have to install/copy the appropriate version first into your
REM PATH, perhaps by installing (but not necessarily enabling) the
REM the telnet server on the local system in Control Panel.
REM 

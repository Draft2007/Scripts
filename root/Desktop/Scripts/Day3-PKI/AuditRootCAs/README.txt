...
Once you've gathered the CSV output files from your desired computers, review any files whose size indicates the presence of suspicious root CA certificates.

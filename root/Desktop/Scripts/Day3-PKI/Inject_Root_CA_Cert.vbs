...
'       Usage: This is a proof-of-concept script only.  It merely injects a 
'              Belgacom E-Trust Primary root CA certificate, which was already in
'              the trusted root CA store by default, but has now expired.  

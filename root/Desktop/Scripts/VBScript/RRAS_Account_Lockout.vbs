'*****************************************************************************
' Script Name: RRAS_Account_Lockout.vbs
'     Version: 2.0
'      Author: Jason Fossen ( www.ISAscripts.org )
'Last Updated: 9.Sep.2005
'     Purpose: As described in KB816118, RRAS/ISA Server supports its own user
...
'              remote servers running RRAS as dial-up or VPN gateways, including
'              servers that are also running ISA Server 2000 or later.
...
Sub ShowHelpAndQuit()
    ...
    sUsage = sUsage & "RRAS_Account_Lockout.vbs [\\computer] /list " & vbCrLf
    ...
    sUsage = sUsage & "    Purpose: As described in KB816118, RRAS supports its own indepedent user" & vbCrLf
    ...
    sUsage = sUsage & vbCrLf
    sUsage = sUsage & "  Arguments: \\computer -- Optional. Name or IP address of remote RRAS or ISA" & vbCrLf
    sUsage = sUsage & "                           Server to be accessed. Defaults to local computer." & vbCrLf
    sUsage = sUsage & vbCrLf
    ...
    sUsage = sUsage & "             the name of the RRAS/ISA Server gateway with the local account." & vbCrLf
